...
CREATE POLICY "delete-product" ON "public"."products" FOR DELETE TO "authenticated" USING (true);
...
CREATE POLICY "read-all" ON "public"."products" FOR SELECT USING (true);

CREATE POLICY "read-write-all" ON "public"."order_items" TO "authenticated" USING (true);

CREATE POLICY "read-write-orders-all" ON "public"."orders" TO "authenticated" USING (true);

CREATE POLICY "update-rows" ON "public"."products" FOR UPDATE TO "authenticated" USING (true);
